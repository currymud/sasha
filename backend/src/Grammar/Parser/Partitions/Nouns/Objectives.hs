...
module Grammar.Parser.Partitions.Nouns.Objectives (floor,table,chair,objectives,pill,mail,satchel,towel,robe) where
...
objectives = HashSet.fromList [pocket,floor,table,chair,pill, mail, satchel, towel, robe]
