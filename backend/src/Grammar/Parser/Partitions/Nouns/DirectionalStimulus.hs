...
import           Model.Parser.Lexer                          (Lexeme (CHAIR, MAIL, PILL, POCKET, ROBE, SATCHEL, TABLE, TOWEL))
...
directionalStimulii = fromList [pill,pocket,mail,satchel,towel,robe,chair,table]
