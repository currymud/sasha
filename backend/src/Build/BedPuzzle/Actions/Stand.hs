...
import           Model.GameState           (ActionEffectKey (LocationKey, ObjectKey, PlayerKey),
                                            ...
                                            Effect (AcquisitionPhraseEffect, AcquisitionVerbEffect, DirectionalStimulusEffect, ImplicitStimulusEffect, NegativePosturalEffect, PositivePosturalEffect, SomaticAccessEffect),
                                            GameComputation,
